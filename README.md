...
className=“”
style={} // {}绑定数据
onClick={} // 注意[bind]或使用[箭头函数]绑定当前组件的this,推荐使用箭头函数获取当前this指向
htmlFor
循环数据加key
首字母大写
constructor中记得加super(),加在this之前

### 键盘事件
onKeyUp，onKeyDown
判断keycode，以判断按了哪个键盘值
...
<input value={this.state.data} onChange={this.setData}/>